  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-6 py-3.5 border-b border-[#E8E5E2] shrink-0 bg-[#FAFAF9]">
        ...
        <div className="flex items-center gap-2.5">
          {!isNew && (
            <button type="button" onClick={() => navigate(`/playground?agent=${id}`)}
              className="flex items-center gap-1.5 text-sm font-medium text-[#2563EB] bg-[#EFF4FF] hover:bg-[#DBEAFE] px-3 py-1.5 rounded-lg border border-[#2563EB]/20 transition-colors">
